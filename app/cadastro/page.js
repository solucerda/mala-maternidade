  ...
  if (sucesso) {
    return (
      <div className="max-w-md mx-auto px-4 py-16 text-center">
        <h1 className="font-display text-2xl text-plum-dark mb-3">Quase lá!</h1>
    ...
    <div className="max-w-md mx-auto px-4 py-16">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input id="telefone" type="tel" required placeholder="(00) 00000-0000" value={telefone} onChange={(e) => setTelefone(e.target.value)}
            className="w-full px-4 py-2.5 rounded-lg border border-plum/20 focus:border-plum outline-none" />
        </div>
        <div>
      ...
      <p className="text-sm mt-6">
        Já tem conta? <Link href="/login" className="text-plum underline">Entrar</Link>
      </p>
    </div>
  );
}
